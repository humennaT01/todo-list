...
public class UserController {
    ...
    public String update(@PathVariable long id, Model model, @Validated @ModelAttribute("user") User user, @RequestParam("roleId") long roleId, @RequestParam("oldPassword") String oldPassword, BindingResult result) {
