...
public class ToDoController {
    ...
    @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('USER') and @toDoController.hasAccessToRead(#id)")
    @GetMapping("/{id}/tasks")
    ...
    public String delete(@PathVariable("todo_id") long todoId, @PathVariable("owner_id") long ownerId) {
        ...
        if (((ToDo) authenticationToken.getDetails()).getId() != todoId) {
    ...
    public boolean hasAccessToRead(long todoId){
